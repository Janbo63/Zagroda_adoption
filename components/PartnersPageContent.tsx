...
const DESCRIPTIONS = {
  pl: {
    ...
    staffInviteDesc: 'Zapraszamy właścicieli, managerów oraz personel recepcji na bezpłatną wizytę i spotkanie z alpakami. Gdy zespół osobiście pozna nasze alpaki, będzie z entuzjazmem polecać tę wizytę Państwa gościom!',
    copyBtn: 'Kopiuj opis',
    ...
    whatsappMessage: 'Dzień dobry! Reprezentuję obiekt noclegowy. Chcielibyśmy skorzystać z bezpłatnego spotkania z alpakami dla naszego personelu recepcji.',
  },
  cs: {
    ...
    staffInviteDesc: 'Zveme majitele, recepční a manažery ubytovacích zařízení na bezplatnou návštěvu a seznámení s alpakami, abyste zážitek mohli s jistotou doporučit hostům!',
    ...
    whatsappMessage: 'Dobrý den! Zastupuji ubytovací zařízení a rádi bychom využili partnerského pozvání na bezplatné setkání s alpakami pro náš personál.',
  },
  en: {
    ...
    staffInviteDesc: 'We invite owners, reception staff, and managers from local accommodation properties for free coffee and a Meet the Alpacas experience so you can experience the farm firsthand and enthusiastically recommend it to guests!',
    ...
    whatsappMessage: 'Hello! I represent an accommodation provider. We would love to take up the VIP invitation for our front-desk staff to visit Zagroda Alpakoterapii.',
  },
  de: {
    ...
    staffInviteDesc: 'Wir laden Inhaber, Rezeptionsteams und Management von Hotels und Pensionen herzlich zu einem kostenlosen Kaffee und einem Alpaka-Treffen ein, damit Sie das Erlebnis persönlich kennenlernen!',
    ...
    whatsappMessage: 'Guten Tag! Ich vertrete eine Unterkunft und wir möchten gerne die Partnereinladung für unser Team nutzen.',
  },
  nl: {
    ...
    staffInviteDesc: 'We nodigen eigenaren, managers en receptieteams van harte uit voor gratis koffie en een ontmoeting met de alpaca’s, zodat u de ervaring zelf kunt aanbevelen!',
    ...
    whatsappMessage: 'Hallo! Ik vertegenwoordig een accommodatie en we willen graag gebruikmaken van de uitnodiging voor ons team.',
  },
};
