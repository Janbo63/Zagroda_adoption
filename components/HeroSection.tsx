...
export function HeroSection({ locale }: HeroSectionProps) {
  ...
  return (
    <>
      ...
      {/* Hero section */}
      <section className="relative w-full aspect-[16/9] mb-8 md:mb-12 rounded-3xl overflow-hidden shadow-lg">
        <Image
          ...
          quality={75}
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 bg-gradient-to-b from-black/30 via-transparent to-white/70">
