                        ...
                        <motion.div variants={fadeUp} className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                            ...
                            <div className="flex gap-3">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white text-sm font-bold transition-all shadow-md hover:scale-105"
                                    onClick={() => trackContactClick({ channel: 'whatsapp', page: '/stay', label: 'help_chat_whatsapp' })}
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#0099FF] hover:bg-[#0080dd] text-white text-sm font-semibold transition-all shadow-md hover:scale-105"
                                    onClick={() => trackContactClick({ channel: 'messenger', page: '/stay', label: 'help_chat_messenger' })}
                                >
